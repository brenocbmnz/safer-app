...
Route::middleware(['auth', 'verified'])->group(function (): void {
    ...
    Route::get('locais', fn () => Inertia::render('locais'))->name('locais');
    Route::get('mapa', fn () => Inertia::render('mapa'))->name('mapa');
});

// JSON API endpoints (web middleware for session-based auth + CSRF)
Route::prefix('api')->name('api.')->group(function (): void {
    // Static routes before parameterized ones to avoid capture
    Route::get('places/externo/google', [GooglePlacesController::class, 'index'])->name('google-places.index');
    Route::get('places/externo/google/{placeId}', [GooglePlacesController::class, 'show'])->name('google-places.show');
